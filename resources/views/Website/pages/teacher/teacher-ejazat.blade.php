                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="profile-data-user-boxes content-user mt-5">
                            <h3 class="h4 mb-3"> الإجازات <span class='badge bg-secondary show-create-form'> انشاء جديد
                                </span> </h3>



                            <form action="{{ route('teacher.store', 'ejazats') }}" method="POST"
                                        ...
                                        <div data-repeater-item class='border-bottom p-3'>
                                            <div class="row">
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12"><input type="text" name="ejazat_name"
                                                                class='form-control mb-2' placeholder='اسم الإجازة   ' />
                                                        </div>
                            ...
                            @foreach ($ejazats as $ejazat)
                                <form action="{{ route('teacher.update', ['ejazats', $ejazat->id]) }}" method="POST"
                                    class="box-about-teacher bg-white border rounded-3 p-4 mb-3 update-form">
