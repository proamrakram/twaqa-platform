                    ...
                    <div class="col-md-9">
                        ...
                        <div class="profile-data-user-boxes content-user mt-5">
                            ...
                            @foreach ($teacher_certificates as $teacher_certificate)
                                <form
                                    action="{{ route('teacher.update', ['teacher-certificate', $teacher_certificate->id]) }}"
                                    ...
                                    <div class="d-flex border-bottom pb-3 mb-3">
                                        ...
                                        <div class="text d-flex justify-content-between w-100 repeater-edit">
                                            <div class="inputs w-75">
                                                <input class="h5 clr-royal-blue mb-1 form-input" name="certificate_name"
                                                    value="{{ $teacher_certificate->certificate_name }}" disabled>

                                                <input class="form-input" name="specialization"
                                                    value="{{ $teacher_certificate->specialization }}" disabled>

                                                <input class="form-input" name="university"
                                                    value="{{ $teacher_certificate->university }}" disabled>


                                                <input class="fw-bold gray-clr font-number form-input" name="year"
                                                    value="{{ $teacher_certificate->year }}" disabled>
                                            </div>
                                            <div class="btns d-flex align-items-start">
                                                <button class='btn-green ms-1 text-white btn-none'> حفظ </button>
                                                <a href="{{ route('teacher.delete', ['teacher-certificate', $teacher_certificate->id]) }}"
