                            ...
                            <div class="bg-white rounded-lg border course mb-3">
                                <div class="heading px-4 py-3 border-bottom">
                                    <div class="d-flex  align-items-center justify-content-between mb-2">
                                        <h3 class='mb-0 h4'> كورس القرأن الكريم </h3>
                                        <span class='badge-span'>حالة الكورس</span>
                                    </div>
                                    <span class='badge-span'>6 ساعات</span>
                                    <span class='badge-span mx-1'>مجموعة</span>
                                    <span class='badge-span'>رجال</span>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <div class="imgs d-flex">
                                                <a href="#"> <img src="assets/img/img-std.png" alt=""> </a>
                                                <a href="#"> <img src="assets/img/img-std.png" alt=""> </a>
                                                <a href="#"> <img src="assets/img/img-std.png" alt=""> </a>
                                                <a href="#"> <img src="assets/img/img-std.png" alt=""> </a>
                                            </div>
                                ...
                                <div class="managment px-4 py-3 border-bottom">
                                    ...
                                    <div class="imgs d-flex align-items-center">
                                        <a href="#"> <img src="assets/img/img-std.png" class='rounded-3 ms-2'
                                                width='40px' height='40px'> </a>
                                        <a href="#" class='clr-royal-blue text-decoration-none'> ياسين كاظمي </a>
                                    </div>
                                </div>
