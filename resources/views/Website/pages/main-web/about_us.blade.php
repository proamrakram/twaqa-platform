            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb py-3 mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> {{ __('Who We Are') }} </li>
                    </ol>
                </nav>
                <div class="heading-page shadow-box  bg-white rounded-lg mb-4 p-4"
                    ...
                    <h1 class="h1 clr-royal-blue text-center fw-bold  mb-0 pt-md-5 pt-3 mt-md-3"> {{ __('Who We Are') }}
                    </h1>
                </div>
            </div>
        </header>
