                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="image-input image-input-empty" data-kt-image-input="true" style="background-image: url({{asset('assets/media/blank.svg')}})">
                            <div class="image-input-wrapper w-125px h-125px" @if(array_key_exists('platform_logo', $setting)) style="background-image: url({{asset('storage/images/website_setting') . '/' .$setting['platform_logo']}})" @endif></div>
