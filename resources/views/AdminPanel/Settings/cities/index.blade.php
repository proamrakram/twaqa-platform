        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                    ...
                    <li class="breadcrumb-item pe-3"><a href="{{route('admin.cities.index')}}" class="pe-3 text-muted">الدول</a></li>
                    <li class="breadcrumb-item pe-3 text-primary">كل الدول</li>
                </ol>
                <a href="{{route('admin.cities.create')}}" class="btn btn-success py-2 rounded fw-bolder"> اضافة جديد </a>
            </div>
                ...
                <div class="card-body fs-6 p-5 text-gray-700">
                    ...
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                            ...
                            <th class="min-w-100px">الدولة </th>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        @foreach($cities as $city)
                                ...
                                <a href="{{route('admin.cities.edit',['id'=>$city->id])}}" class="text-dark text-hover-primary"> {{$city->city_name}} </a>
                            </td>  <td>
                               {{$city->country->country_name}} 
                            </td>
                            <td class="text-end">
                              @if($city->status == 'active')  <span class="badge badge-light-success">فعال @else 
                                         ...
                                         <td class="text-end">
                                            <div class="btn-actions d-flex align-items-center justify-content-end">
                                                <label class="me-5 form-check form-switch form-check-custom form-check-solid d-inline-block">
                                                    <input class="form-check-input h-20px w-40px" type="checkbox" onclick="window.location='{{ route("admin.cities.changeStatus",["id"=>$city->id]) }}'" id="flexSwitchCheckChecked" @if($city->status == 'active') checked="" @endif/>
                                                </label>                                    
                                                ...
                                                <a   data-action="{{route('admin.cities.delete',['id'=>$city->id])}}" data-name="{{$city->city_name}}"  class="rm" >
