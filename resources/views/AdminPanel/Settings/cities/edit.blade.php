                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-5">
                                ...
                                <input type="text" name="city_name_ar" value="{{$city->city_name_ar}}" class="form-control form-control-solid  @error('city_name_ar') is-invalid @enderror"  >
                                @error('city_name_ar')
                            ...
                            <div class="col-md-12 mb-5">
                                ...
                                <input type="text" name="city_name_en" value="{{$city->city_name_en}}" class="form-control form-control-solid  @error('city_name_en') is-invalid @enderror"  >
                                @error('city_name_en')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12 mb-5">
                                ...
                                <input type="text" name="city_name_sp" value="{{$city->city_name_sp}}" class="form-control form-control-solid  @error('city_name_sp') is-invalid @enderror"  >
                                @error('city_name_sp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12 mb-5">
                                 <label class="form-label fw-bolder"> الدولة</label>
                                            ...
                                            <select name="country_id" class="form-select form-select-solid @error('country_id') is-invalid @enderror" data-control="select2" data-dropdown-css-class="w-200px" data-placeholder="اختر .." data-hide-search="true">
                                                ...
                                                <option @if($city->country_id==$country->id) selected @endif value="{{$country->id}}">{{$country->country_name}} </option>
                                                @endforeach
                                            </select>
                                            @error('country_id')
                                            <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-12">
                                ...
                                <label class="ms-5 form-check form-switch form-check-custom form-check-solid d-inline-block">
                                    <input name="status" class="form-check-input h-20px w-40px  @error('status') is-invalid @enderror" type="checkbox" value="active"    @if($city->status == "active")checked="checked" @endif/>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
