    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <a href="teachers-add-new.php" class="btn btn-success py-2 rounded fw-bolder"> اضافة جديد </a>
            </div>
                ...
                <div class="card-body fs-6 p-5 text-gray-700">
                    ...
                    <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_teachers">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr>
                                <td>
                                <a href="#" class="text-dark text-hover-primary">محمد كمال</a>
                                </td>
                                <td>
                                   محمد احمد 
                                </td>
                                ...
                                <td data-order="2022-03-10T14:40:00+05:00"> <span  class="badge badge-primary"> علي احمد </span> </td>
                                <td class="text-center pe-0">  10 </td>
                                <td class="text-center pe-0">  15 </td>
                                <td class="text-center pe-0">20   </td>
                                <td class="text-end">
                                مجموعة
                                </td>     
                                <td class="text-end">
                                    <div class="btn-actions d-flex align-items-center justify-content-end">
                                        <label class="me-5 form-check form-switch form-check-custom form-check-solid d-inline-block">
                                            <input class="form-check-input h-20px w-40px" type="checkbox" value="1" checked="checked"/>
                                        </label>                                    
                                        <a href="#">
