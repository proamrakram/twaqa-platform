            ...
            <div class="card">
                <div class="card-body fs-6 p-5 text-gray-700">
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            <td>
                            <a href="{{route('admin.supervisors.edit',['id'=>$user->id])}}" class="text-dark text-hover-primary">{{$user->name}}</a>
                            </td>
                            <td>
                            {{$user->email}}
                            </td>
                            ...
                            <td class="text-end">
                                            <div class="btn-actions d-flex align-items-center justify-content-end">
                                                ...
                                                <a  data-action="{{route('admin.supervisors.delete',['id'=>$user->id])}}"    data-name="{{$user->name}}" class="rm">
