        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                    ...
                    <li class="breadcrumb-item pe-3"><a href="{{route('admin.lessons.index')}}" class="pe-3 text-muted">الحصص</a></li>
                    <li class="breadcrumb-item pe-3 text-primary">كل الحصص</li>
                </ol>
            </div>
                ...
                <div class="card-body fs-6 p-5 text-gray-700">
                    ...
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                            <th class="min-w-100px">اسم الكورس </th>
                            <th class="min-w-100px">اسم المعلم</th>
                            <th class="min-w-100px">تاريخ الحلقة</th>
                            <th class="min-w-100px">وقت بدء الحلقة</th>
                            <th class="min-w-100px">وقت انتهاء الحلقة</th>
                            <th class="min-w-100px">الاعدادات</th>
                        </tr>
                        <!--end::Table row-->
                    </thead>
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            <td>
                            <a href="#" class="text-dark text-hover-primary">{{$lesson->course->name}}</a>
                            </td>
                            
                            <td>
                            <a href="#" class="text-dark text-hover-primary">{{$lesson->teacher->name}}</a>
                            </td>
                            <td>
                            {{$lesson->getDay}}({{$lesson->date}})
                            </td>
                            <td>
                            {{$lesson->time_from}}
                            </td>
                            ...
                            <td class="text-end">
                                            <div class="btn-actions d-flex align-items-center justify-content-end">
                                                ...
                                                <a  href="{{route('admin.lessons.edit-time',['id'=>$lesson->id])}}">
                                                ...
                                                <a  href="{{route('admin.lessons.edit-status',['id'=>$lesson->id])}}">
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary  ">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M2 4.63158C2 3.1782 3.1782 2 4.63158 2H13.47C14.0155 2 14.278 2.66919 13.8778 3.04006L12.4556 4.35821C11.9009 4.87228 11.1726 5.15789 10.4163 5.15789H7.1579C6.05333 5.15789 5.15789 6.05333 5.15789 7.1579V16.8421C5.15789 17.9467 6.05333 18.8421 7.1579 18.8421H16.8421C17.9467 18.8421 18.8421 17.9467 18.8421 16.8421V13.7518C18.8421 12.927 19.1817 12.1387 19.7809 11.572L20.9878 10.4308C21.3703 10.0691 22 10.3403 22 10.8668V19.3684C22 20.8218 20.8218 22 19.3684 22H4.63158C3.1782 22 2 20.8218 2 19.3684V4.63158Z" fill="currentColor"/>
                                                            <path d="M10.9256 11.1882C10.5351 10.7977 10.5351 10.1645 10.9256 9.77397L18.0669 2.6327C18.8479 1.85165 20.1143 1.85165 20.8953 2.6327L21.3665 3.10391C22.1476 3.88496 22.1476 5.15129 21.3665 5.93234L14.2252 13.0736C13.8347 13.4641 13.2016 13.4641 12.811 13.0736L10.9256 11.1882Z" fill="currentColor"/>
