        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                    ...
                    <li class="breadcrumb-item pe-3 text-primary">كل الطلاب</li>
                </ol>
                <a href="{{route('admin.students.create')}}" class="btn btn-success py-2 rounded fw-bolder"> اضافة جديد </a>
            </div>
            ...
            <div class="card">
                <div class="card-body fs-6 p-5 text-gray-700">
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            <td>
                            <a href="{{route('admin.students.edit',['id'=>$user->id])}}" class="text-dark text-hover-primary">{{$user->full_name}}</a>
                            </td>
                            <td>
                            {{$user->email}}
                            </td>
                            ...
                            <td data-order="2022-03-10T14:40:00+05:00">@if($user->gender == 'male')ذكر @else أنثى @endif</td>
                            ...
                            <td class="text-end">
                                            <div class="btn-actions d-flex align-items-center justify-content-end">
                                                <label class="me-5 form-check form-switch form-check-custom form-check-solid d-inline-block">
                                                    <input class="form-check-input h-20px w-40px" type="checkbox" onclick="window.location='{{ route("admin.students.changeStatus",["id"=>$user->id]) }}'" id="flexSwitchCheckChecked" @if($user->active == 1) checked="" @endif/>
                                                </label>                                    
                                                ...
                                                <a  data-action="{{route('admin.students.delete',['id'=>$user->id])}}"   data-name="{{$user->full_name}}" class="rm">
...
bootbox.dialog({
  message: "<form class='form-inline add-to-ban' method='GET'><div class='form-group'>هل تريد تأكيد حذف الطالب  "+current_object.attr('data-name')+" ?</div></form>",
  title: "حذف",
  buttons: {
    success: {
      label: "حذف",
