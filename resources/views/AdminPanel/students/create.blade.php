                    ...
                    @csrf
                        <div class="row">
                            ...
                            @error('age')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row gx-2">
                                        <div class="col-6">
                                            <input name="country"  type="text"  value="{{old('country')}}" class="form-control form-control-solid @error('country') is-invalid @enderror" placeholder='الدولة'>
                            ...
                            @error('country')
                                    ...
                                    @enderror
                                        ...
                                        <div class="col-6">
                                            <input name="state"  type="text"  value="{{old('state')}}" class="form-control form-control-solid @error('state') is-invalid @enderror" placeholder='المحافظة'>
                            ...
                            @error('phonenumber2')
                                    ...
                                    <div class="col mb-3">
                                        ...
                                        <input name="whatsapp"  value="{{old('whatsapp')}}" type="text" class="form-control form-control-solid @error('whatsapp') is-invalid @enderror" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-5">
                                ...
                                <input name="parent_position" type="text"  value="{{old('parent_position')}}" class="form-control form-control-solid @error('parent_position') is-invalid @enderror" placeholder='  '>                             
