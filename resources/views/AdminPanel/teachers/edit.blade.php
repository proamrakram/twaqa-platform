        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                <div class="card-body fs-6 p-5 text-gray-700">
                    ...
                    <form method="post" action="{{ route('admin.teachers.update',['id'=>$user->id]) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
            ...
            <form method="post" action="{{ route('admin.teachers.update-qualifications',['id'=>$user->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="card mt-4">
                    <div class="card-body fs-6 p-5 text-gray-700">
                        ...
                        <div class='certificate'>
                            ...
                            <div class="form-group">
                                <div data-repeater-list="qualification">
                                    ...
                                    <?php $i = 0 ?>
                                    @foreach($user->qualifications as $c)
                                    ...
                                    <div data-repeater-item>
                                        <div class="form-group row  ">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="qualification_degree" value="{{$c->qualification_degree}}" class="form-control mb-2 mb-md-0" placeholder="درجة المؤهل الدراسي" />
                                    ...
                                    <?php $i++ ?>
                                    @endforeach
                                    @if(is_null($user->qualifications))
            ...
            <form method="post" action="{{ route('admin.teachers.update-certificates',['id'=>$user->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="card mt-4">
                    <div class="card-body fs-6 p-5 text-gray-700">
                                    ...
                                    <div data-repeater-item>
                                        <div class="form-group row  ">
                                            <div class="col-md-3">
                                                ...
                                                <input type="hidden" class="form-control mb-2 " name="id" value="{{$c->id}}">
                                                <input type="text" name="certificate_name" value="{{$c->certificate_name}}" class="form-control mb-2 mb-md-0" placeholder="اسم الشهادة" />
            ...
            <form method="post" action="{{ route('admin.teachers.update-working-hours',['id'=>$user->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="card mt-4">
                    <div class="card-body fs-6 p-5 text-gray-700">
            ...
            <form method="post" action="{{ route('admin.teachers.update-password',['id'=>$user->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="card mt-4">
                    <div class="card-body fs-6 p-5 text-gray-700">
