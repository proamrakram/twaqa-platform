        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                    ...
                    <li class="breadcrumb-item pe-3"><a href="{{route('admin.teachers.new')}}" class="pe-3 text-muted">المعلمين</a></li>
                    <li class="breadcrumb-item pe-3 text-primary">المعلمين الجدد</li>
                </ol>
               </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                            <div class="btn-actions d-flex align-items-center justify-content-end">
                                                ...
                                                <a  href="{{route('admin.teachers.delete',['id'=>$user->id])}}"   onclick="return confirm('هل انت متأكد من حذف ({{$user->full_name}})?')">
