        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                    ...
                    <li class="breadcrumb-item pe-3"><a href="{{route('admin.courses-types.index')}}" class="pe-3 text-muted">نوع الكورس</a></li>
                    <li class="breadcrumb-item pe-3 text-primary">اضافة جديد</li>
                </ol>
            </div>        
            <div class="row">
                <div class="col-md-4">
                <form  method="post" action="{{ route('admin.courses-types.store') }}" enctype="multipart/form-data">
                    @csrf
                                         ...
                                         <td class="text-end">
                                            <div class="btn-actions d-flex align-items-center justify-content-end">
                                                <label class="me-5 form-check form-switch form-check-custom form-check-solid d-inline-block">
                                                    <input class="form-check-input h-20px w-40px" type="checkbox" onclick="window.location='{{ route("admin.courses-types.changeStatus",["id"=>$type->id]) }}'" id="flexSwitchCheckChecked" @if($type->active == 1) checked="" @endif/>
                                                </label>                                    
                                                <a  href="{{route('admin.courses-types.edit',['id'=>$type->id])}}">
                                                ...
                                                <a  data-action="{{route('admin.courses-types.delete',['id'=>$type->id])}}" data-name="{{$type->title}}"  class="rm">
...
bootbox.dialog({
  message: "<form class='form-inline add-to-ban' method='GET'><div class='form-group'>هل تريد تأكيد حذف نوع الكورس    "+current_object.attr('data-name')+" ?</div></form>",
  title: "حذف",
  buttons: {
    success: {
      label: "حذف",
