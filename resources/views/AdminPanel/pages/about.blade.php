        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                    ...
                    <li class="breadcrumb-item pe-3 text-primary">من نحن ؟</li>
                </ol>
            </div> 
            
            <form  method="post" action="{{ route('admin.pages.update-about') }}" enctype="multipart/form-data">
                    @csrf
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="paeg_ar" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text"name="about_title_ar"  value="{{$pages['about_title_ar'] ?? ''}}" class="form-control form-control-solid   @error('about_title_ar') is-invalid @enderror" > 
                        @error('about_title_ar')
                                ...
                                <textarea name="about_description_ar"   id="summary-ckeditor-ar"   class="form-control @error('about_description_ar') is-invalid @enderror "  rows="20" > {{ $pages['about_description_ar'] ?? '' }}</textarea>
                            ...
                            <div class="tab-pane fade" id="paeg_en" role="tabpanel" dir='ltr'>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="about_title_en"  value="{{$pages['about_title_en'] ?? ''}}" class="form-control form-control-solid   @error('about_title_en') is-invalid @enderror" >  
                        @error('about_title_en')
                                ...
                                <div class="content-page">
                                <textarea name="about_description_en"  id="summary-ckeditor-en" class="form-control @error('about_description_en') is-invalid @enderror "  rows="20" >{{ $pages['about_description_en'] ?? '' }}</textarea>
                            ...
                            <div class="tab-pane fade" id="paeg_sp" role="tabpanel" dir='ltr'>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="about_title_sp" value="{{$pages['about_title_sp'] ?? ''}}" class="form-control form-control-solid   @error('about_title_sp') is-invalid @enderror" >   
                        @error('about_title_sp')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror                         
                                ...
                                <div class="content-page">
                                    <textarea name="about_description_sp"   id="summary-ckeditor-sp"  class="form-control @error('about_description_sp') is-invalid @enderror "  rows="20" >{{ $pages['about_description_sp'] ?? '' }}</textarea>
                                                                            
                        @error('about_description_sp')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
