        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                    ...
                    <li class="breadcrumb-item pe-3 text-primary">كل الكورسات</li>
                </ol>
                    ...
                    <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_teachers">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                ...
                                <th class="min-w-100px">المعلم</th>
                                <th class="min-w-100px"> المشرف </th>
                                <th class="text-end min-w-75px"> قيمة الاشتراك </th>
                                <th class="text-end min-w-75px">قيمة الساعة</th>
                                <th class="text-end min-w-75px"> عدد الساعات </th>
                                <th class="text-end min-w-75px"> نوع الكورس </th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                <td>
                                <a href="{{route('admin.courses.edit',['id'=>$course->id])}}" class="text-dark text-hover-primary">{{$course->name}}</a>
                                </td>
                                <td>
                                ...
                                <td data-order="2022-03-10T14:40:00+05:00"> <span  class="badge badge-primary">  {{$course->supervisor->name}} </span> </td>
                                <td class="text-center pe-0">    {{$course->student_price}}  {{$course->student_currency->name}} </td>
                                <td class="text-center pe-0">   {{$course->teacher_price}} {{$course->teacher_currency->name}}  </td>
...
var KTDatatablesExample = function () {
    ...
    // Hook export buttons
    var exportButtons = () => {
        const documentTitle = 'كل الكورسات في أكاديمية تواقة';
...
bootbox.dialog({
  message: "<form class='form-inline add-to-ban' method='GET'><div class='form-group'>هل تريد تأكيد حذف الكورس  "+current_object.attr('data-name')+" ?</div></form>",
  title: "حذف",
  buttons: {
    success: {
      label: "حذف",
