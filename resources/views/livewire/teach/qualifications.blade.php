<div>
    <form action="#" class="box-about-teacher bg-white border rounded-3 p-4 mb-3 update-form">
        <div class="d-flex border-bottom pb-3 mb-3">
            ...
            <div class="text d-flex justify-content-between w-100 repeater-edit">
                ...
                <div class="btns d-flex align-items-start" wire:ignore.self>
                    @if ($edit)
                        <button type="button" class='btn-green ms-1 text-white' wire:click='update'>حفظ</button>
                    @endif
