<div class="profile-data-user-boxes content-user mt-5">
    ...
    <div class="box mb-4">
        <div class="heading d-flex justify-content-between align-items-center mb-2">
            ...
            <div class="d-flex">
                @if ($edit_1)
                    <button type="submit" class='btn-green ms-1 text-white' wire:click='updateEmail' wire:ignore.self> حفظ
                    </button>
                @endif
    ...
    <div class="box mb-4">
        <div class="heading d-flex justify-content-between align-items-center mb-2">
            ...
            <div class="d-flex">
                @if ($edit_2)
                    <button type="submit" class='btn-green ms-1 text-white' wire:click='updatePassword'
                        wire:ignore.self>
                        حفظ </button>
                @endif
        ...
        <div class="bg-white rounded-lg">
            <div class="input border-bottom p-3 position-relative">
                ...
                <i class="fa-regular fa-eye position-absolute top-50 start-0 translate-middle-y ps-4 pt-4"></i>
            ...
            <div class="input border-bottom p-3 position-relative">
                ...
                <input type="password" wire:model="confirm_password" @if (!$edit_2) disabled @endif
                    class='form-input font-number {{ $edit_2 }}' placeholder="***********">
                <i class="fa-regular fa-eye position-absolute top-50 start-0 translate-middle-y ps-4 pt-4"></i>
