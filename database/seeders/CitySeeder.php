...
class CitySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($eygpt_names as $ar_eygpt_names => $en_eygpt_names) {
            DB::table('cities')->insert(
                [
                    "city_name_en" => $en_eygpt_names,
                    "city_name_ar" => $ar_eygpt_names,
                    "country_id" => 1,
                    "status" => "active",
                    'is_delete' => 0,
                ]
        ...
        foreach ($saudi_arabia_names as $ar_saudi_arabia_name => $en_saudi_arabia_name) {
            DB::table('cities')->insert(
                [
